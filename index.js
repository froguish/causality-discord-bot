...
client.on("messageCreate", async (message) => {
    ...
    if (message.content.includes("CAUSALITY HAS ENDED YOUR JOURNEY")) console.log("Journey has ended.")
    if (message.content.includes("THOU HAS BESTED CAUSALITY")) console.log("Journey has been completed.")
